...
class SensorAdapterManager(object):
	...
	sets the scheduler at pollRate
	...
	def handleTelemetry(self):
		...
		logging.debug('Generated temperature data: '+ str(tempData))
		...
		if not self.useEmulator:
			...
			tempData = \
				self.dataGenerator.generateDailyIndoorTemperatureDataSet(\
					minValue= temperatureFloor, maxValue= temperatureCeiling, useSeconds= False
				)
